...
**Project:** Exploring the Nuclear Structure Using Laser Spectroscopy Techniques
...
Oct. 2024 – Present, Leuven, Belgium  
- Research on nuclear structure using laser spectroscopy techniques.  
- Experimental design and optimization.  
- Participating in teaching and other educational activities.

---

**R&D Engineer**  
Oncotech Medical Systems  
Jul. 2022 – May 2023, Ankara, Turkey  
- Researched and developed algorithms for medical data and image processing.  
- Prototyped a MATLAB-based DICOM-RT viewer with a GUI.  
- Developed a low-cost optical surface tracking system for SGRT in C++ using OpenCV and CUDA.

---

**Scientific Project Specialist**  
Research and Application Center for Space and Accelerator Technologies at METU  
Jan. 2020 – Jun. 2022, Ankara, Turkey  
- Performed magnetic alignment and proton beam parameter calculations.  
- Led Monte Carlo simulations and radiation dose calculations.  
- Developed image processing tools for chaotic system analysis and mentored interns.

---

**Undergraduate Researcher**  
Research and Application Center for Space and Accelerator Technologies at METU  
Dec. 2018 – Jan. 2020, Ankara, Turkey  
- Developed MATLAB-based image processing software for beam diagnostics.  
- Assisted in proton beamline calculations and irradiation test design.
